...
let%expect_test "parserhawk: IR spec vs synthesized pipeline" =
  let spec_program = TestModulePrograms.parserhawk_sai_spec in
  let synth_parser = get_parser "../test/parserhawk_sai_solution.ir" in
  let synth_program = TestModulePrograms.sai_dump_headers synth_parser
    { TestModulePrograms.h1 = Shim.int_to_pos 1; h2 = Shim.int_to_pos 2;
      h3 = Shim.int_to_pos 3; h4 = Shim.int_to_pos 4; h5 = Shim.int_to_pos 5;
      h6 = Shim.int_to_pos 6; h7 = Shim.int_to_pos 7; h8 = Shim.int_to_pos 8;
      h9 = Shim.int_to_pos 9 } in
