 ...
 *
 * ConQuest's baseline forwarding program, with its routing decision rewritten
 * as a shift and a mask: a Tofino-native program with a sub-parser, intrinsic metadata, and an
